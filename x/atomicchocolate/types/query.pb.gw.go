...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"kempy007", "atomic-chocolate", "atomicchocolate", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Projects_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"kempy007", "atomic-chocolate", "atomicchocolate", "projects"}, "", runtime.AssumeColonVerbOpt(true)))
)
