 ...
 */
export type AtomicchocolateParams = object;

export interface AtomicchocolateProject {
  creator?: string;
...
export interface AtomicchocolateQueryProjectsResponse {
  Project?: AtomicchocolateProject[];
...
/**
 * @title atomicchocolate/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/kempy007/atomic-chocolate/atomicchocolate/params
   */
